...
export const UI: Record<string, Record<Lang, string>> = {
  ...
  loginSubtitle:    { en: "Professional GED Exam Preparation", th: "เตรียมสอบ GED อย่างมืออาชีพ", my: "G.E.D. စမ်းပြဿနာ ကျွန်ုပ်ရှင်ရှင်ဖောက်မြန်မား" },
  ...
  // -- Sidebar / Nav --
  home:             { en: "Home",          th: "หน้าหลัก",          my: "မနက်" },
  ...
  resetProgress:    { en: "Reset All Progress",    th: "รีเซตข้อมูลการเรียน",  my: "ရလဒ်အားလုံး ပြန်သတ်မှတ်ပါ" },
  resetConfirm:     { en: "Reset all data?",       th: "ต้องการรีเซตข้อมูลทั้งหมด?", my: "ရလဒ်အားလုံးကို ပြန်သတ်မှတ်မည်လား?" },
  resetDesc:        { en: "All progress and scores will be deleted. This cannot be undone.", th: "ความคืบหน้า และ คะแนนทั้งหมด จะถูกลบ. คุณต้องเริ่มเรียนใหม่", my: "ရလဒ်နှင့် မြှောင်းမှတ်များ အားလုံး ဖျက်ပါသည်။ နောက်ပြန်မပြုနိုင်ပါ။" },
  confirmReset:     { en: "Reset",    th: "ยืนยันรีเซต",          my: "ပြန်သတ်မှတ်ပါ" },
  ...
  lessonsCompleted: { en: "Lessons Done",   th: "บทเรียนที่เสร็จ",      my: "ပြီးပြည်ပြီးသော ပုံမှန်များ" },
  ...
  overallProgress:  { en: "Overall Progress",th: "ความคืบหน้ารวม",    my: "အပြည့်စုံ ရလဒ်" },
  ...
  lessonQuiz:       { en: "Lesson Quiz",   th: "แบบทดสอบบทเรียน", my: "ပုံမှန် စမ်းပြဿနာ" },
  ...
  // -- Rigor --
  dailyMission:     { en: "Daily Mission",      th: "สถานะภารกิจประจำวัน",  my: "နေ့စဉ် တာဝန်ခေါ်မှု" },
  disciplineScore:  { en: "Discipline Score",   th: "คะแนนวินัย",        my: "စည်မာခြံ မြှောင်း" },
  ...
  backToLesson:     { en: "Lesson",         th: "บทเรียน",       my: "ပုံမှန်" },
  backToDashboard:  { en: "Dashboard",      th: "แดชบอร์ด์",     my: "ဒက်ရှ်ဘာဖြာ" },
  lessons:          { en: "Lessons",        th: "บทเรียน",       my: "ပုံမှန်များ" },
  lessonsCount:     { en: "{count} lessons",  th: "{count} บทเรียน",  my: "ပုံမှန် {count} ခု" },
  ...
  subjectTestDesc:  { en: "Test your understanding of all lessons in this subject", th: "ทดสอบความเข้าใจรวมทุกบทเรียนในวิชานี้", my: "ဤဘာသာစကားရဲ့ ပုံမှန်အားလုံးကို နားလည်မှု စမ်းသပ်ပါ" },
  ...
  backToLessonBtn:  { en: "Back to Lesson", th: "กลับบทเรียน",       my: "ပုံမှန်သို့ ပြန်သွားပါ" },
  ...
  vocabMsgHigh:     { en: "Excellent! You remember vocabulary well. Ready for the next lesson!", th: "ยอดเยี่ยม! คุณจดจำคำศัพท์ได้ดีมาก พร้อมเรียนบทต่อไป!", my: "ကောင်းလွန်း! စကားလုံးများကို ကျွန်ုပ် မှတ်သားနိုင်ပါသည်။ နောက် ပုံမှန်သို့ အဆင်သင့်ပါသည်!" },
  ...
  lockReasonLesson:{ en: "Locked - Complete previous lesson first", th: "ล็อค - ทำบทเรียนก่อนหน้าให้เสร็จก่อน", my: "ပိုက်ထားသည် - ရှေ့ ပုံမှန်ကို ပြီးပြည်ပြီးပါ" },
